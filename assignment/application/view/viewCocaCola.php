      ...
      <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <!-- Dropdown -->
                  <li class="nav-item">
                      <a id="navModels" class="nav-link"  href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="X3D Models" data-content="There are three X3D models: Fanta, appletiser and diet coke">Models</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="main_contents" id='home'>
           ...
           <div id="myCarousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class=" carousel-item active">
                  <img src="../assignment/application/assets/images/dCoke.jpg" alt="banner1">
                </div>

                <div class="carousel-item">
                  <img src="../assignment/application/assets/images/costa.jpg" alt="banner2">
                </div>

                <div class="carousel-item">
                  <img src="../assignment/application/assets/images/appletiser.jpg" alt="banner3">
                  </div>

                  <div class="carousel-item">
                  <img src="../assignment/application/assets/images/fanta.jpg" alt="banner4">
                  </div>
                </div>
                </div>
              </div>
                  ...
                  <div class="col-sm-8">
                      <div class="card img-narrow">
                          <div class="card-body">
                                ...
                                <h><?php echo $data[0]['item_Description1'] ?></h>    
                            <a href="https://www.fanta.com/" class="btn btn-primary btn-responsive">Find out more ...</a>                 
                          </div>
                      </div>
                  </div>
                  <div class="col-sm-4">
                    <a href="../assignment/application/assets/images/renderImages/fanta.jpg" data-fancybox data-caption="My 3D Coke Can Render">
                            <img class="card-img-top img-fluid img-thumbnail" src="../assignment/application/assets/images/fantaBrand.jpg" alt="Coca Cola">
                    </a>
                  </div>
            </div>
            <div class="row">  
                   <div class="col-sm-4">
                    <a href="../assignment/application/assets/images/renderImages/apple.jpg" data-fancybox data-caption="My 3D Sprite Bottle Render" class="img-narrow">
                            <img class="card-img-top img-fluid img-thumbnail" src="../assignment/application/assets/images/appletiserBrand.jpg" alt="Sprite">
                    </a>
                  </div>
            <div class="col-sm-8">
                      <div class="card">
                          <div class="card-body">
                            ...
                            <h><?php echo $data[0]['item_Description2'] ?></h>   
                            <a href="https://www.appletiser.com/en/products/appletiser" class="btn btn-primary btn-responsive">Find out more ...</a>
                          </div>
                  ...
                  <div class="col-sm-8">
                      <div class="card img-narrow">
                          <div class="card-body">
                            ...
                            <h><?php echo $data[0]['item_Description3'] ?></h>   
                            <a href="https://www.coca-cola.co.uk/" class="btn btn-primary btn-responsive">Find out more ...</a>
                          </div>
                      </div>
                  </div>
                  <div class="col-sm-4">
                  <a href="../assignment/application/assets/images/renderImages/dCoke.jpg" data-fancybox data-caption="My 3D Pepper Cup Render" class="thumbnail">
                            <img class="card-img-top img-fluid img-thumbnail" src="../assignment/application/assets/images/dietCoke.jpg" alt="Dr Pepper">
                  </a>
                  </div>
            </div>
          ...
          <div id="about" style="display:none;">
            <div id= "about"class="card-body">
                ...
                <br>
                Github Link:<a href="https://github.com/polski3000/Web3D.git">Click Here</a>
                <br>
                Link to X3D files:<a href="https://github.com/polski3000/Web3D/tree/main/application/assets/x3d">Click Here</a>
                </h2>                                   
           </div>
        </div>  
        <!-- End Statement -->
      ...
      <!-- Gallery -->
        ...
        <!-- End Gallery -->
          ...
          <div id="models" class="main_contents" style="display:none;">
            ...
            <div class="row">
              <!-- X3D Model -->
              <div class="col-sm-8" style="left: 250px;">
                <div class="card text-left ">
                  ...
                  <div class="card-body">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-success btn-responsive" onMouseUp="spriteScene(); spriteDescription();">Appletiser</button>
                        <button type="button" class="btn btn-success btn-responsive" onMouseUP="pepperScene(); pepperDescription();">Diet Coke</button>
                          ...
                          <x3d id="wire">
                            <scene>
                                <Switch whichChoice="0" id='SceneSwitch'>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../assignment/application/assets/x3d/fantaA.x3d" > </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../assignment/application/assets/x3d/apple.x3d"> </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../assignment/application/assets/x3d/dietCoke.x3d"> </inline>
                                    </transform>
                                </Switch>
                            </scene>
                          </x3d>
                      ...
                      <div class="col-sm-8">
                            <div class="card text-left">
                              ...
                              <div class="card-Title x3dCamera_Subtitle drinksText">
                                ...
                                <audio  id="myAudio" >
                                <source src="./application/assets/audio/cokeSong.mp3" type="audio/mp3">
                                ...
                                <div class="card-text x3dCameraDescription drinksText">
                                <p>Click play to listen to the coca cola theme song taste the feeling</p>
                                </div>
                          </div> <!-- end of audio-->
                                </div>
                            </div>
              ...
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                        ...
                        <a href="https://www.appletiser.com/en/products/appletiser" class="btn btn-primary btn-responsive">Visit Sprite</a>                 
                      </div>
                  </div>
              </div>
              ...
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                        ...
                        <a href="https://www.coca-cola.co.uk/" class="btn btn-primary btn-responisve">Visit Pepper.</a>                 
                      </div>
                  </div>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Sebastian Green, Email: Polishdudes@gmail.com</p>
                </div>
